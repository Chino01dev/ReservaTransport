...
namespace EF___ReservaTransporte.Controllers
{
    public class VehiculoesController : Controller
    {
        ...
        public VehiculoesController(EfReservaTransporteContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("VehiculoId,Marca,Modelo,Placa")] Vehiculo vehiculo)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("VehiculoId,Marca,Modelo,Placa")] Vehiculo vehiculo)
        {
